...
import "../BapForm/BecomeAPartner.css";
import MainButton from "../../../atoms/Buttons/MainButton/MainButton";
import useBap from "../../../../hooks/useBap";
        ...
        <Container className="inputContainer">
            <Row className="inputBackground">
                ...
                <Col xs={12} className="mt-3 pt-1">
                    <input
                        type="text"
                        className={`input_1 ${companyError ? "is-invalid" : ""}`}
                        placeholder={"Company"}
                        value={company}
                        onChange={(e) => setCompany(e.target.value)}
                    />
                    {companyError && (
                        <div className="text-danger small">{companyError}</div>
                    )}
                </Col>
