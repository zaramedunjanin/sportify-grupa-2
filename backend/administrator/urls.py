...
urlpatterns = [
        ...
        path('tables/users/update/<int:id>/', views.putUser),
        ...
        path('tables/sports/update/<int:id>/', views.putSport),
        ...
        path('tables/venues/update/<int:id>/', views.putVenue),
        ...
        path('tables/reservations/update/<int:id>/', views.putReservation),
        ...
        path('tables/acceptedinvites/update/<int:id>/', views.putInvite),
        ...
        path('tables/questions/update/<int:id>/', views.putQuestion),
        ...
        path('tables/ratings/update/<int:id>/', views.putRating),
        ...
        path('tables/verification/update/<int:id>/', views.putCompany),
]
